...
/*
 * ✅ What we can test with InMemoryConnector
 *
 ...
 *
 * ❌ What we cannot test with InMemoryConnector
 *
 * ✖ Whether Jackson (or Avro, Protobuf, etc.) correctly serializes your payload
 * ✖ Whether the Kafka producer configuration (key/value serializer) is working
 * ✖ Whether the message is actually accepted by Kafka
 */
@QuarkusTest
